...
const FloatingCartButton: React.FC<FloatingCartButtonProps> = ({ itemCount, onCartClick }) => {
  ...
  return (
    <button
      onClick={onCartClick}
      className="fixed bottom-6 right-6 bg-cafe-blue text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 z-40 md:hidden"
    >
